      ...
      >
        ...
        >
          <a :href="imgArray[imgArray.length-1].href" class="img-container">
            <FakeImg :src="imgArray[imgArray.length-1].src" :height="height" :width="WIDTH"></FakeImg>
          </a>
        </li>
        <li
          class="carousel-element"
        ...
        >
          <a :href="imgArray[0].href" class="img-container">
            <FakeImg :src="imgArray[0].src" :height="height" :width="WIDTH"></FakeImg>
          </a>
        </li>
      </ul>
    </div>
...
export default {
  ...
  methods: {
    itemClick (item,ind) {
      this.$emit('beforeClick', item,ind);
  ...
  mounted() {
    const WIDTH = parseFloat(
      window.getComputedStyle(this.$el, null).getPropertyValue("width")
    );
    this.WIDTH = WIDTH;
